...
async function generateMindMapFromGPT() {
  ...
  // ✅ ここで finalPrompt を構築
const finalPrompt = `
以下は、地域課題とそれに対する住民の考察です。

このうち、【課題リスト】に含まれる10件の課題を最も重視してください。  
中心ノードには「${region}：${theme}」を設定し、【課題リスト】の10件を第一階層（中心ノードの直下）に展開してください。

各課題については、原因・背景 → 解決の方向性 → 想定される施策例 などを含む3〜4階層の構造にしてください。  
【住民の考察】は補足的に使用し、課題の深掘りに加える程度に留めてください。
